"""Build Windows portable zip artifact with optional code signing."""
...
from voicekey.release.windows_artifacts import build_signtool_command, create_portable_zip
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=True,
        type=Path,
        help="Portable runtime directory that will be zipped.",
    )
    parser.add_argument(
        "--output-dir",
        default="dist",
        type=Path,
        help="Directory where canonical portable archive is written.",
    )
    parser.add_argument(
        "--signtool-path",
        default=None,
